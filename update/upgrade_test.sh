...
echo " "
        ...
        if [[ -e $NODERED_HOME/.nvm ]]; then
            ...
            echo -ne "  Update Node.js LTS                  $CHAR"
        elif [ "$nv" = "v0" ] || [ "$nv" = "v1" ] || [ "$nv" = "v3" ] || [ "$nv" = "v4" ] || [ "$nv" = "v5" ] || [ "$nv" = "v6" ] || [ "$nv" = "v7" ] || [ "$nv" = "v9" ] || [ "$nv" = "v11" ] || [ "$nv2" = "v8.11.1" ] || [ "$nv2" = "v10.15.2" ]; then
            ...
            if [[ -f /etc/apt/sources.list.d/nodesource.list ]]; then
                ...
                if [ "$nv" = "v0" ] || [ "$nv" = "v1" ] || [ "$nv" = "v3" ] || [ "$nv" = "v4" ] || [ "$nv" = "v5" ] || [ "$nv" = "v6" ] || [ "$nv" = "v7" ] ||[ "$nv" = "v9" ] ||[ "$nv" = "v11" ] || [ "$nv2" = "v8.11.1" ] || [ "$nv2" = "v10.15.2" ]; then
